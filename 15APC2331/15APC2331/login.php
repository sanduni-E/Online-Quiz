...
if(isset($_POST['u_name'])){
  ...
  $result = mysqli_query($conn,"select * from main.2 where u_name='$u_name' && new_password='$new_password' ") or die ("Failed to query database".$mysql_error);
...
<body>
  <div class="container">
    ...
    <div class="login-box">
      ...
      <p><font size="4"><b>New User please </b><a href="regisq.php"><b>register here</b></a></font></p>
