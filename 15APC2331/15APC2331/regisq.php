<?php
 ...
 // echo "connected";
  ...
  if(isset($_POST['reg_btn'])){
     ...
     $s="select * from main.2 where u_name='$u_name'";
...
echo'</script>';
     ...
     $query="insert into main.2(first_name, last_name, u_name, email, contact_no, new_password, retype_password) values ('$first_name', '$last_name', '$u_name', '$email', '$contact_no', '$new_password', '$retype_password')";
